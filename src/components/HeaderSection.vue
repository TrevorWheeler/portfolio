<template>
  <header class="menu--mobile">
    <a href="https://github.com/trevorwheeler" target="_blank" rel="noreferrer">
      <svg data-aos="zoom-in" data-aos-delay="400" data-aos-duration="1000" width="36" height="37" viewBox="0 0 36 37"
        fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="githubTitle githubDesc" role="img">
    ...
    <a href="mailto: sendtrevmail@gmail.com" target="_blank" rel="noreferrer">
      <svg data-aos="zoom-in" data-aos-delay="500" data-aos-duration="1000" width="36" height="35" viewBox="0 0 36 35"
        fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="emailTitle emailDesc" role="img">
        <title id="emailTitle">link to send Trevor Wheeler an email</title>
        <desc id="emailDesc">envelope image indicating to contact via email</desc>
        <path d="M32.1104 11.3188V15.4128L34.7594 13.4059L32.1104 11.3188Z" fill="#06D6A0" />
        <path d="M17.661 0L14.9316 2.08715H20.3904L17.661 0Z" fill="#06D6A0" />
        <path d="M23.0386 24.5642L35.3207 34.1972V15.0114L23.0386 24.5642Z" fill="#06D6A0" />
        <path
          ...
          fill="#06D6A0" />
        <path d="M17.6602 28.8189L13.5662 25.6078L1.5249 35H33.7955L21.7542 25.6078L17.6602 28.8189Z" fill="#06D6A0" />
        <path d="M0 15.0114V34.1972L12.2821 24.5642L0 15.0114Z" fill="#06D6A0" />
        <path d="M3.21109 11.3188L0.562012 13.4059L3.21109 15.4128V11.3188Z" fill="#06D6A0" />
        <path
    ...
    <a href="https://www.linkedin.com/in/trevor-wheeler-95a46659/" target="_blank" rel="noreferrer">
      <svg data-aos="zoom-in" data-aos-delay="600" data-aos-duration="1000" width="35" height="35" viewBox="0 0 35 35"
        fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="linkedInTitle linkedInDesc" role="img">
