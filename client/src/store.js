...
export default new Vuex.Store({
	...
	actions: {
		...
		editProject({ commit }, payload) {
			...
			axios
				.put('https://trevorwheeler.dev/api/users/' + this.state.id + '/projects/' + payload.id, payload, {
					headers: {
						'Content-Type': 'application/json',
						Authorization: 'Bearer ' + this.state.token
					}
		...
		deleteProject: function({ dispatch }, payload) {
			axios
				.delete('https://trevorwheeler.dev/api/users/' + this.state.id + '/projects/' + payload, {
					headers: {
						'Content-Type': 'application/json',
						Authorization: 'Bearer ' + this.state.token
					}
